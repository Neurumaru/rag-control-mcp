...
class VectorAdapter(BaseAdapter):
    ...
    async def _get_health_details(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self.send_request(
                "vector.info", {"collection_name": self.module.config.collection_name}
            )
        ...
        return {
            ...
            "operations": {
                ...
                "add": {
                    ...
                    "returns": {"added_count": {"type": "integer"}},
                },
                "delete": {
                    "description": "Delete vectors from collection",
                    "parameters": {"ids": {"type": "array", "description": "Vector IDs to delete"}},
                    "returns": {"deleted_count": {"type": "integer"}},
                },
                "validate": {
                    ...
                    "parameters": {
                        "vector": {
                            "type": "array",
                            "description": "Vector to validate",
                        },
    ...
    async def _delete_vectors(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        mcp_params = {"collection_name": self.module.config.collection_name, "ids": ids}
    ...
    async def _delete_collection(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        mcp_params = {"collection_name": collection_name}
    ...
    async def add_documents(
        ...
        parameters = {"vectors": embeddings, "ids": ids, "metadata": metadatas}
        ...
        try:
            for i, val in enumerate(vector):
                if not isinstance(val, (int, float)):
                    return {
                        "valid": False,
                        "message": f"Vector element {i} is not a number",
                    }
                ...
                if val == float("inf") or val == float("-inf"):
                    return {
                        "valid": False,
                        "message": f"Vector element {i} is infinite",
                    }
