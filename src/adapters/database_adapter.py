...
class DatabaseAdapter(BaseAdapter):
        ...
        if isinstance(value, str):
            ...
            for pattern in self._compiled_patterns:
                if pattern.search(value):
                    self.logger.warning(
                        "Potentially dangerous SQL value detected",
                        extra={
    ...
    async def _get_health_details(self) -> Dict[str, Any]:
        ...
        try:
            ...
            response = await self.send_request(
                "database.info", {"database_name": self.module.config.database_name}
            )
        ...
        return {
            ...
            "operations": {
                ...
                "insert": {
                    ...
                    "returns": {"inserted_count": {"type": "integer"}},
                },
                "update": {
                    ...
                    "returns": {"updated_count": {"type": "integer"}},
                },
            },
        }
    ...
    async def _execute_query(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        mcp_params = {"database_name": self.module.config.database_name, "sql": sql}
    ...
    async def _delete_records(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        mcp_params = {"database_name": self.module.config.database_name, "table": table}
        ...
        return {"deleted_count": response.result.get("deleted_count", 0)}
    ...
    async def _create_table(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"table": table, "created": response.result.get("created", False)}
    ...
    async def _drop_table(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        ...
        return {"table": table, "dropped": response.result.get("dropped", False)}

    async def _list_tables(self, parameters: Dict[str, Any]) -> Dict[str, Any]:
        """List all tables in database."""
        mcp_params = {"database_name": self.module.config.database_name}
    ...
    async def select(
        ...
        result = await self._execute_query({"sql": sql, "parameters": params if params else None})

        return result["rows"]

    async def insert(self, table: str, record: Dict[str, Any]) -> Dict[str, Any]:
        """High-level INSERT operation for single record."""
        return await self._insert_records({"table": table, "records": [record]})

    async def update(
        self, table: str, updates: Dict[str, Any], where: Dict[str, Any] = None
    ) -> Dict[str, Any]:
        """High-level UPDATE operation."""
        return await self._update_records({"table": table, "updates": updates, "where": where})

    async def delete(
        self, table: str, where: Dict[str, Any] = None, confirm_delete_all: bool = False
    ) -> Dict[str, Any]:
        """High-level DELETE operation."""
        return await self._delete_records(
            {"table": table, "where": where, "confirm_delete_all": confirm_delete_all}
        )
