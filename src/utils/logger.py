...
def log_error_with_context(
    error: Exception, context: Dict[str, Any], module_name: str = "unknown"
) -> None:
...
def log_performance_metric(
    operation: str, duration_ms: float, success: bool = True, **metadata
) -> None:
...
def create_langgraph_logger(thread_id: str) -> Any:
    ...
    """
    return logger.bind(langgraph_thread_id=thread_id, component="langgraph")
