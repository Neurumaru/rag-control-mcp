...
class LangGraphMonitor:
    ...
    def record_checkpoint_event(self, event_type: str, checkpoint_id: str) -> None:
        ...
        log_langgraph_checkpoint_event(
            event_type, self.thread_id, checkpoint_id
        )
    ...
    def get_execution_summary(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "avg_execution_time_ms": total_duration / total_executions if total_executions > 0 else 0,
