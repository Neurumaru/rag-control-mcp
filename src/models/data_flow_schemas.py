...
from .module import DataSchema, DataType, ModuleCapabilities, ModuleType
...
class ModuleSchemaRegistry:
    ...
    @classmethod
    def create_module_capabilities(
        cls, module_type: ModuleType, **kwargs
    ...
    def _supports_batch(module_type: ModuleType) -> bool:
        ...
        non_batch_types = {ModuleType.SESSION_MANAGER, ModuleType.CONDITIONAL_ROUTER}
