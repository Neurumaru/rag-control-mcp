...
class JSONStorage:
    ...
    def get_storage_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "modules_file_size": self.modules_file.stat().st_size if self.modules_file.exists() else 0,
            "pipelines_file_size": self.pipelines_file.stat().st_size if self.pipelines_file.exists() else 0,
        }
